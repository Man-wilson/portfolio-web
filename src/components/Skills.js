const Skills = () => {
    ...
    return (
        <div className="container py-5">
            <h2 className="text-center head-title pt-5 mb-5  text-light">My skills</h2>
            <div className="row">
                <div className="col-md-7">
                    <div className="pr-0 pr-md-5">
                        <h2 className="font-sz-24 font-wg-700 color-white mb-4">My creative skills & experience.</h2>
