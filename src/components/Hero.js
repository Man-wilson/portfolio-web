                ...
                <div className="row py-2 d-flex align-items-center">
                    <div className="col-md-7 pl-5">
                        <h2 className="content highlight color-white font-wg-700">
                            Hello, my name is  <br />
                            <span className="name-edit"> Munezero Aime</span> <br /> <span className='high-2'>I'm a</span>   
                            <TextLoop>
                        ...
                        <button type="button" href="Section.js" class="btn btn-info">Hire me</button>

                        <p className="role font-sz-16 font-wg-500 color-white mt-5">Senior Front End Engineer <a href="https://google.com">@ishemahub</a></p>
                    </div>
