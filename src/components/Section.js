                ...
                <h2 className="title text-white">
                 ...
                 <div className="row">
                     <div className="col-md-5">
                         ...
                         <div className="">
                             <div className="d-flex">
                                 <i className="fas fa-user text-white mr-4">
                                 </i>
                                 <div className=" mb-2">
                             ...
                             <div className="d-flex">
                                 <i className="fas fa-map-marker-alt text-white mr-4">
                                 </i>
                                 <div className=" mb-2">
                             ...
                             <div className="d-flex">
                                 <i className="fas fa-envelope text-white mr-4">
                                 </i>
                                 <div className=" mb-2">
                             ...
                             <div className="d-flex">
                                 <i className="fas fa-phone text-white mr-4">
                                 </i>
                                 <div className=" mb-2">
                     ...
                     <div className="col-md-7 column right">
                        ...
                        <form action="https://formspree.io/f/mdobezpw" method="POST" id="my-form">
                         <div class="fields">
